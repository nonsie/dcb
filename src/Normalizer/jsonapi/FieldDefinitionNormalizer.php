...
use Drupal\schemata_json_schema\Normalizer\jsonapi\FieldDefinitionNormalizer as JsonApiFieldDefinitionNormalizer;
...
class FieldDefinitionNormalizer extends JsonApiFieldDefinitionNormalizer {
  ...
  public function normalize($entity, $format = NULL, array $context = []) {
    ...
    //print '<pre>' . print_r($entity->getItemDefinition(), TRUE) . '</pre>';
