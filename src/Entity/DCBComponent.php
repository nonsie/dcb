 ...
 *   },
 *   links = {
 *     "canonical" = "/admin/structure/dcb_component/{dcb_component}",
 *     "add-page" = "/admin/structure/dcb_component/add/{region_id}",
 *     "add-form" = "/admin/structure/dcb_component/add/{dcb_component_type}/{region_id}",
 *     "edit-form" = "/admin/structure/dcb_component/{dcb_component}/edit",
 *     "delete-form" = "/admin/structure/dcb_component/{dcb_component}/delete",
 *     "version-history" = "/admin/structure/dcb_component/{dcb_component}/revisions",
 *     "revision" = "/admin/structure/dcb_component/{dcb_component}/revisions/{dcb_component_revision}/view",
 *     "revision_revert" = "/admin/structure/dcb_component/{dcb_component}/revisions/{dcb_component_revision}/revert",
 *     "revision_delete" = "/admin/structure/dcb_component/{dcb_component}/revisions/{dcb_component_revision}/delete",
 *     "translation_revert" = "/admin/structure/dcb_component/{dcb_component}/revisions/{dcb_component_revision}/revert/{langcode}",
 *     "collection" = "/admin/structure/dcb_component",
 *   },
